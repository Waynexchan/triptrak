...
SECRET_KEY = 'django-insecure-5ph3_b4)$1u=hpk+wv%i&%e(0d#jv7-p4$8792(gxr04mx1^&z'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # 添加这行，设定查找静态文件的目录
]
...
# where should the user after login - if not next
